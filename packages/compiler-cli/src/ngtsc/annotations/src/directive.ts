...
export class DirectiveDecoratorHandler implements
  ...
  detect(node: ClassDeclaration, decorators: Decorator[]|null):
    ...
    // abstract directive. This is technically deprecated behavior as of v9, but
    // we want to detect these patterns so that we can report diagnostics, or
    // compile them for backwards compatibility (ngcc does this).
    if (!decorators) {
